...
if((isset($_POST['name-free-consult-im'])&&$_POST['name-free-consult-im']!="")&&(isset($_POST['phone-free-consult-im'])&&$_POST['phone-free-consult-im']!="")) {//Проверка отправилось ли наше поля name и не пустые ли они
    ...
    $message = '
                <html>
                    ...
                    <body>
                        <p>Имя: ' . $_POST['name-free-consult-im'] . '</p>
                        <p>Телефон: ' . $_POST['phone-free-consult-im'] . '</p>
                        <p>Комментарий: ' . $_POST['comment-free-consult-im'] . '</p>
                    </body>
                </html>'; //Текст нащего сообщения можно использовать HTML теги
    $headers = "Content-type: text/html; charset=utf-8 \r\n"; //Кодировка письма
    $send = mail($to, $subject, $message, $headers);
    ...
    $message .= '<b>Имя: </b>' . $_POST['name-free-consult-im'] . "\n";
    $message .= '<b>Фамилия: </b>' . $_POST['phone-free-consult-im'] . "\n";
    $message .= '<b>Комментарий: </b>' . $_POST['comment-free-consult-im'] . "\n";
